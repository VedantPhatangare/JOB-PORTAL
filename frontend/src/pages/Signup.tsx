...
const Signup = () => {
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if(form.role == "Recruiter") navigate("/login?role=Recruiter");else navigate("/login")
  ...
  return (
    <div className="relative w-[25%] h-[90vh]">
      ...
      <form
        ...
        <button
          type="submit"
          className={ `${form.role===""? " bg-gray-800": form.role =="Candidate"?"bg-blue-500": "bg-purple-500"} mt-12 w-full  text-white font-medium tracking-wide px-8 py-2.5 rounded-sm cursor-pointer transition-all duration-500 hover:bg-black`}
        >
      ...
      <div className="mb-4">
        ...
        <span
          ...
          onClick={() =>{
            form.role==="Recruiter"? navigate("/login?role=Recruiter"): navigate("/login")
          }}
        >
          Login
        </span>
